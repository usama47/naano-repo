  ...
  if (stage === "sent") {
    return (
      <Card className="p-6">
        ...
        <p className="mt-4 font-semibold">Request sent to {creator.name.split(" ")[0]}</p>
        <p className="mt-2 text-sm text-muted">
          Creators on the marketplace reply within about {creator.responseHours} hours. Nothing is
          charged until a post is published.
        </p>
